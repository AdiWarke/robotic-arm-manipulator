...
#include "arduinobot_msgs/srv/detail/add_two_floats__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arduinobot_msgs::srv::AddTwoFloats_Request;
    is_plain =
      (
      offsetof(DataType, b) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const arduinobot_msgs::srv::AddTwoFloats_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arduinobot_msgs::srv::AddTwoFloats_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AddTwoFloats_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const arduinobot_msgs::srv::AddTwoFloats_Request *>(
...
static size_t _AddTwoFloats_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AddTwoFloats_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AddTwoFloats_Request__callbacks = {
  "arduinobot_msgs::srv",
...
static rosidl_message_type_support_t _AddTwoFloats_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AddTwoFloats_Request__callbacks,
...
{
  return &arduinobot_msgs::srv::typesupport_fastrtps_cpp::_AddTwoFloats_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = arduinobot_msgs::srv::AddTwoFloats_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arduinobot_msgs::srv::AddTwoFloats_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<arduinobot_msgs::srv::AddTwoFloats_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AddTwoFloats_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const arduinobot_msgs::srv::AddTwoFloats_Response *>(
...
static size_t _AddTwoFloats_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AddTwoFloats_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AddTwoFloats_Response__callbacks = {
  "arduinobot_msgs::srv",
...
static rosidl_message_type_support_t _AddTwoFloats_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AddTwoFloats_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &arduinobot_msgs::srv::typesupport_fastrtps_cpp::_AddTwoFloats_Response__handle;
}
...
static service_type_support_callbacks_t _AddTwoFloats__callbacks = {
  "arduinobot_msgs::srv",
  "AddTwoFloats",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arduinobot_msgs, srv, AddTwoFloats_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arduinobot_msgs, srv, AddTwoFloats_Response)(),
...
static rosidl_service_type_support_t _AddTwoFloats__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AddTwoFloats__callbacks,
...
{
  return &arduinobot_msgs::srv::typesupport_fastrtps_cpp::_AddTwoFloats__handle;
}
